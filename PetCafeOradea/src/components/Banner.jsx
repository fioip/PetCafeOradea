...
function Banner() {
  ...
  return (
    // Added classes to hide on tablet
    <div className="relative w-full h-screen sm:hidden lg:block">
      <img
        src={imgURL}
        alt="Banner"
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div
          className="absolute top-0 bottom-0 right-0 bg-[#633404]/90 text-[#FEF2DA] p-6 w-full xl:w-1/2 backdrop-blur-md flex flex-col justify-between
           lg:backdrop-blur-lg lg:shadow-2xl"
          style={{ textShadow: "4px 4px 9px rgba(0, 0, 0, 1)" }}
        >
          <div className="mt-12 md:-mt-8">
            <h1 className="text-5xl lg:text-5xl font-bold text-center mt-[40px]">
              {title}
            </h1>
            <div className="flex flex-row justify-center items-center gap-4 mt-8">
              <PiPawPrintFill
                className="text-5xl lg:text-6xl text-[#EF7F00]"
                style={{ transform: "rotate(340deg)" }}
              />
              <h1 className="text-[40px] lg:text-6xl font-bold text-center">
                {cafe}
              </h1>
              <PiPawPrintFill
                className="text-5xl lg:text-6xl text-[#EF7F00]"
          ...
          <div className="flex flex-1 items-center justify-center">
            <h2 className="text-4xl lg:text-5xl xl:text-4xl text-center leading-[50px] lg:leading-[70px] xl:leading-[50px]">
              {motto}
            </h2>
          </div>
