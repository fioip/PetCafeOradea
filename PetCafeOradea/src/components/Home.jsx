      ...
      <div className="bg-[#FFF8EA]">
        ...
        <div className="mt-12 mx-6 md:mt-16 md:ml-16 lg:mt-20 lg:ml-20 ">
          <div className="flex flex-col items-center md:items-start md:ml-12 lg:ml-24">
            <h1 className="text-4xl md:text-4xl lg:text-4xl font-bold text-[#633404]">
              Despre Noi
            </h1>
            <IoRemoveOutline
              className="text-6xl md:text-7xl lg:text-8xl -mt-5 md:-mt-6 lg:-mt-10 
            ml-0 md:ml-8 lg:ml-11 text-[#EF7F00] w-14 md:w-16 lg:w-20"
            />
          </div>
          <h2
          ...
          <Link to="/contact">
            <button
              ...
              border-4 border-white pl-6 pr-5 pt-3 pb-3 md:pl-10 md:pr-8 text-lg md:text-xl text-white font-bold 
        ...
        >
          <div className="flex flex-col items-center md:items-start md:ml-12 lg:ml-20">
            <div className="flex flex-col items-center justify-center">
              <h1 className="text-4xl md:text-4xl font-bold text-[#633404] text-center lg:ml-8">
                Animăluțele Noastre
              </h1>

              {/* Linia responsive sub titlu */}
              <div className="mt-2 md:mt-3 lg:mt-1">
        ...
        <div className="mt-24 mx-6 md:mt-32 lg:mt-32">
          <div className="flex flex-col items-center md:items-start md:ml-12 lg:ml-24">
            <div className="flex flex-col items-center justify-center">
              <h1 className="text-4xl md:text-4xl font-bold text-[#633404] text-center lg:ml-14">
                Regulament
              </h1>

              {/* Linia responsive sub titlu */}
              <div className="mt-2 md:mt-3 lg:mt-1 lg:ml-7">
                <IoRemoveOutline className="text-[#EF7F00] text-6xl md:text-7xl lg:text-8xl -mt-5 md:-mt-6 lg:-mt-10" />
              </div>
            </div>
            <ul
              className="flex flex-col gap-6 mt-6 mb-20 text-[#633404] list-disc list-inside text-justify md:mr-12 
            lg:mr-16 text-lg md:text-3xl lg:text-2xl leading-7 md:leading-relaxed lg:leading-10 sm:leading-6"
            >
              <li>
