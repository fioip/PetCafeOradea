...
function Galerie() {
  return (
    <div className="md:ml-[25%] lg:ml-[25%] xl:ml-[20%]">
      <Banner />
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-6 bg-[#FDF6EC]">
        {/* Mira */}
        {Mira.map((mira, index) => (
          <div key={index} className="relative flex flex-col bg-white rounded-3xl shadow-lg overflow-hidden p-6 transition-transform hover:scale-105">
            {/* Imaginea animalului */}
            <div className="relative flex justify-center items-center">
              ...
              <h1 className="absolute inset-0 flex justify-center items-center text-2xl md:text-3xl lg:text-4xl font-bold text-[#FDF6EC] bg-black/40 rounded-3xl p-4">
                {mira.animalTitle}
              </h1>
            </div>
